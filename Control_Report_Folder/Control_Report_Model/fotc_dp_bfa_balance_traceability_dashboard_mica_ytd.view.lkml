...
# The name of this view in Looker is "Fotc Dp Bfa Balance Traceability Dashboard Mica Ytd"
view: fotc_dp_bfa_balance_traceability_dashboard_mica_ytd {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: @{server_name_fine}.@{schema_name}.FOTC_DP_BFA_BALANCE_TRACEABILITY_DASHBOARD_MICA_YTD
    ;;
