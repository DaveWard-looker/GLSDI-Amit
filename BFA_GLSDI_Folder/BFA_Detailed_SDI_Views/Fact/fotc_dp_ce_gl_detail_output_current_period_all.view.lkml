view: fotc_dp_ce_gl_detail_output_current_period_all {
...
# }
  ...
  dimension: mica_code {
    ...
    sql: ${TABLE}.mica_code ;;
    link: {
      label: "Drill To Parent Level"
      url: "/explore/BFA_SDI_Data_Discovery_R3/fotc_dp_ce_gl_detail_output_current_period_all?fields=fotc_dp_ce_gl_detail_output_current_period_all.gl_balance_in_reporting_currency,cc_mica.child_code,cc_mica.leaf_code,fotc_dp_ce_gl_detail_output_current_period_all.mica_code,cc_mica.parent_code,cc_mica.group_code,cc_mica.group_index,cc_mica.group_description,cc_mica.leaf_description&f[fotc_dp_ce_gl_detail_output_current_period_all.format]=M&f[fotc_rd_bfa_mi_combined_dimensions.parent_code]={{fotc_rd_bfa_mi_combined_dimensions.parent_code._value | url_encode}}&f[fotc_rd_bfa_mi_combined_dimensions.leaf_code]=-EMPTY&sorts=cc_mica.group_index&limit=500"
      icon_url: "https://www.google.com/s2/favicons?domain=looker.com"
    }
    link: {
      label: "Drill To Child Level"
      url: "/explore/BFA_SDI_Data_Discovery_R3/fotc_dp_ce_gl_detail_output_current_period_all?fields=fotc_dp_ce_gl_detail_output_current_period_all.gl_balance_in_reporting_currency,cc_mica.child_code,cc_mica.leaf_code,fotc_dp_ce_gl_detail_output_current_period_all.mica_code,cc_mica.parent_code,cc_mica.group_code,cc_mica.group_index,cc_mica.group_description,cc_mica.leaf_description&f[fotc_dp_ce_gl_detail_output_current_period_all.format]=M&f[fotc_rd_bfa_mi_combined_dimensions.child_code]={{fotc_rd_bfa_mi_combined_dimensions.child_code._value | url_encode}}&f[fotc_rd_bfa_mi_combined_dimensions.leaf_code]=-EMPTY&sorts=cc_mica.group_index&limit=500"
      icon_url: "https://www.google.com/s2/favicons?domain=looker.com"
    }
  }
