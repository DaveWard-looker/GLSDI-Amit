view: fotc_rd_mi_flat_dimension_fotc_product_rollup_cmb {
  ...
  derived_table: {
    ...
    where dimension_tree_id = {% parameter dimension_tree_id_parameter_cmb %} and dimension ='Global_Standard_Product'  ;;
  ...
  dimension: dimension_tree_id_base {
    ...
    hidden: yes
    type: string
    sql: case when ${dimension_tree_id_db} in ('WPB1', 'WPB2', 'WPB3', 'CMB1', 'GBM1','1') then  case when ${dimension_tree_id_db} end;;
  }
