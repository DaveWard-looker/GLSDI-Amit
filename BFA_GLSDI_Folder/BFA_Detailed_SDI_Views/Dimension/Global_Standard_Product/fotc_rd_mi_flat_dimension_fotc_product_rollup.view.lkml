view: fotc_rd_mi_flat_dimension_fotc_product_rollup {

    label: "Global Standard Product"
    derived_table: {
    sql:  select * from  @{server_name_fire}.@{schema_name}.FOTC_RD_BFA_MI_FLAT_DIMENSIONS_LOOKER
    where dimension_tree_id = {% parameter dimension_tree_id_parameter %} and dimension ='Global_Standard_Product'  ;;
     #datagroup_trigger: Global_Standard_Product
 }
  ...
  dimension: dimension_tree_id_db {
    ...
    hidden: yes
    type: string
    sql: case when ${TABLE}.dimension_tree_id ;;
    ...
    dimension: dimension_tree_id_WPB1 {
      ...
      hidden: yes
      type: string
      sql: case when ${dimension_tree_id_db} ('WPB1') then  ${dimension_tree_id_db} end;;
    ...
    dimension: dimension_tree_id_GBM1 {
      ...
      hidden: yes
      type: string
      sql: case when ${dimension_tree_id_db} then  ${dimension_tree_id_db} end;;
    ...
    dimension: dynamic_product_hierarchy {
      ...
      sql: case
        ...
        END ;;
      drill_fields: [description_0,description_1,description_2,description_3,description_4,leaf]
    }




    parameter: dimension_tree_id_parameter {
    ...
    dimension: dimension_tree_id {
      ...
      # view_label: "Product"
      sql: case
          WHEN {% parameter dimension_tree_id_parameter %} = 'WPB1' THEN ${dimension_tree_id_WPB1}
          WHEN {% parameter dimension_tree_id_parameter %} = 'WPB2' THEN  ${dimension_tree_id_WPB2}
          WHEN {% parameter dimension_tree_id_parameter %} = 'WPB3' THEN ${dimension_tree_id_WPB3}
          WHEN {% parameter dimension_tree_id_parameter %} = 'CMB1' THEN ${dimension_tree_id_cmb}
          WHEN {% parameter dimension_tree_id_parameter %} = '1' THEN ${dimension_tree_id_All}
        else ${dimension_tree_id_GBM1}

        END ;;
      drill_fields: [description_0,description_1,description_2,description_3,description_4,description_5,description_6,leaf]
    }
  ...
  # parameter: dimension_tree_id_parameter_cmb_wbp {
  #   #required_access_grants: [explorer_security_wpb_1]
  #   label: "Dimension Tree Id"
  #   #description: "Dynamic Filter for Product Parameter for the filtering data at different Level of Hierarchy"
  #   type: string
  ...
  # dimension: dimension_tree_id_cmb_wpb {
  #   required_access_grants: [explorer_security_bfa_all]
  #   description: "Dynamic Product Level of Hierarchical Dimension of Product Filter Selection "
  #   type: string
  #   label_from_parameter: product_parameter
  ...
  # }
    ...
    parameter: dimension_tree_id_parameter_cmb {
    ...
    dimension: dimension_tree_id_cmb1 {
      label: "Dimension Tree Id"
      required_access_grants: [explorer_security_cmb_1]
      description: "Dynamic Product Level of Hierarchical Dimension of Product Filter Selection "
      type: string
      label_from_parameter: product_parameter
      # view_label: "Product"
      sql: case WHEN {% parameter dimension_tree_id_parameter_cmb %} = 'CMB1' THEN ${dimension_tree_id_cmb} else ${dimension_tree_id_All} END ;;
      drill_fields: [drill_description_fields*]
    }

  # dimension: Global_Standard_Product_level_search{
  #   label: "Global Standard Product Level Search"
  #   group_label: "Hierarchy Search"
  #   primary_key: no
  #   sql: ${TABLE}.level_search ;;
  #   drill_fields: [leaf,level_0,level_1,level_2,level_3,level_4,level_5,level_6]
  # }
