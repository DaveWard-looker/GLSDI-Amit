# The name of this view in Looker is Global_Standard_Segment


view: Global_Standard_Segment {
  label: "Segment"
  derived_table: {
   sql:select * from @{server_name_fire}.@{schema_name}.FOTC_RD_BFA_MI_FLAT_DIMENSIONS_LOOKER where dimension ='Global_Standard_Segment' and dimension_tree_id ='1' ;;
